...
public class Car {
	...
	//[접근 제한자] [수정자] 데이터타입 필드명;
	
	public Car(){}; // 기본 생성자로서 선언 또는 기술하지 않아도 자바에서 자동으로 생성됨
	...
	// [접근제한자] 반환타입 메서드명{[데이터타입매게변수]} {활동 / 행위 / 기능 }
	...
	public int speedUp() {	//(speed의)반환 타입이 int이므로 return 해주어야 하는 것은 정수(int)이어야 함
